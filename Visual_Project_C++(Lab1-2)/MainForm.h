...
namespace VisualProjectCLab12 {
	...
	private: System::Windows::Forms::ToolStripMenuItem^ ïîñòğîèòüToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ öâåòÒåêñòàToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ ïàğàìåòğûØğèôòàToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ ñîõğàíèòüToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ ãğàôèêToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^ ïîñòğîèòüToolStripMenuItem1;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Ââåäèòå ïåğåìåííûå:";
			// 
			// label3
			// 
			...
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->òàáëèöàToolStripMenuItem,
					this->ãğàôèêToolStripMenuItem, this->î÷èñòèòüÏîëÿToolStripMenuItem, this->îáÀâòîğåToolStripMenuItem
			});
			...
			this->òàáëèöàToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->ïîñòğîèòüToolStripMenuItem,
					this->öâåòÒåêñòàToolStripMenuItem, this->ïàğàìåòğûØğèôòàToolStripMenuItem, this->ñîõğàíèòüToolStripMenuItem
			});
			...
			this->öâåòÒåêñòàToolStripMenuItem->Size = System::Drawing::Size(257, 30);
			this->öâåòÒåêñòàToolStripMenuItem->Text = L"Öâåò òåêñòà";
			// 
			// ïàğàìåòğûØğèôòàToolStripMenuItem
			// 
			this->ïàğàìåòğûØğèôòàToolStripMenuItem->Name = L"ïàğàìåòğûØğèôòàToolStripMenuItem";
			this->ïàğàìåòğûØğèôòàToolStripMenuItem->Size = System::Drawing::Size(257, 30);
			this->ïàğàìåòğûØğèôòàToolStripMenuItem->Text = L"Ïàğàìåòğû øğèôòà";
			// 
			...
			this->Text = L"Âèçóàëüíîå ïğîãğàììèğîâàíèå_Âàõğàìååâ_Âàğèàíò 2";
